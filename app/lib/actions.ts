...
// These server functions can then be imported and used in Client 
...
export async function createInvoice(prevState: State, formData: FormData) {
  ...
  const validatedFields = CreateInvoice.safeParse({
      customerId: formData.get('customerId'), //this is set under the name field
      amount: formData.get('amount'), //of <select> and <input> etc. 
    ...
    // You can test error handling like this
